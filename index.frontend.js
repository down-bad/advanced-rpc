/* Version: 1.6.0 - March 6, 2023 18:32:44 */
(function () {
  'use strict';
  ...
  `,
    data: () => ({
      ...
      versionInfo: "ARPC 1.6.0 - March 6, 2023 18:32:44",
  ...
  class AdvancedRpcFrontend {
    ...
    async getRemoteData() {
      if (!this.gettingRemoteData) {
        ...
        try {
          this.remoteData = await fetch("https://cdn.jsdelivr.net/gh/down-bad/advanced-rpc@dev-main/remote/data.json").then(response => response.json());
    ...
    async getLatestVersion(init) {
      if (!this.gettingLatestVersion) {
        ...
        try {
          const {
            version
          } = await fetch("https://cdn.jsdelivr.net/gh/down-bad/advanced-rpc@main/package.json").then(async response => response.json());
    ...
    async getChangelog() {
      if (!this.gettingChangelog) {
        ...
        try {
          const changelog = await fetch("https://cdn.jsdelivr.net/gh/down-bad/advanced-rpc@dev-main/remote/changelog.html").then(async response => response.text());
